...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, delta$2$1, b$1, a$1) {
    return (function() {
      if (($uD(delta$2$1.apply__O()) < 0.0)) {
        return $m_sci_Set$EmptySet$()
      } else {
        var this$7 = $m_s_Predef$().Set$3;
        var a$2 = $uD(delta$2$1.apply__O());
        var jsx$3 = $uD($g.Math.sqrt(a$2));
        var jsx$2 = $uD(b$1.apply__O());
        var jsx$1 = $uD(a$1.apply__O());
        var a$3 = $uD(delta$2$1.apply__O());
        var array = [((jsx$3 - jsx$2) / (2 * jsx$1)), (((-$uD($g.Math.sqrt(a$3))) - $uD(b$1.apply__O())) / (2 * $uD(a$1.apply__O())))];
        var elems = new $c_sjsr_WrappedVarArgs().init___sjs_js_Array(array);
